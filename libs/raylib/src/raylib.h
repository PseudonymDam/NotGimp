...
extern "C" {            // Prevents name mangling of functions
    ...
    RLAPI void DrawRectangleSmooth(Vector2 startPoint, Vector2 endPoint, float size, Color color);                 // Draw a color-filled rectangle with pro parameters
    RLAPI void DrawCircleSmooth(Vector2 pos, float radius, Color color);
    ...
    RLAPI void DrawTextureExFlipV(Texture2D texture, Vector2 position, float rotation, float scale, Color tint);  // Draw a Texture2D with extended parameters
    RLAPI void DrawTextureRec(Texture2D texture, Rectangle source, Vector2 position, Color tint);            // Draw a part of a texture defined by a rectangle
    RLAPI void DrawTextureProFlipV(Texture2D texture, Rectangle source, Rectangle dest, Vector2 origin, float rotation, Color tint); // Draw a part of a texture
